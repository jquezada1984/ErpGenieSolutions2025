...
class Usuario(db.Model):
    """Columnas alineadas con InicioNestJs/src/entities/usuario.entity.ts y la tabla real en BD."""
    ...
    scope_acceso = db.Column(db.String(20), nullable=False, server_default='EMPRESA')
