...
/**
 * Schema de validación para el formulario Editar Producto.
 * Keys 1:1 con los nombres del formulario y payload.
 * Validación solo en submit (mode: "onSubmit").
 */
export const EditarProductoSchema = yup.object({
  producto_ref: yup
    .string()
...
export type EditarProductoFormValues = yup.InferType<typeof EditarProductoSchema>;
